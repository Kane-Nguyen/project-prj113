...
public class buyservlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cartCookie.setMaxAge(0);  // This will remove the cookie
        response.addCookie(cartCookie);

        Cookie quantityCookie = new Cookie("quantity", "");
        quantityCookie.setMaxAge(0);  // This will remove the cookie
        response.addCookie(quantityCookie);
        System.out.println("Inside doPost of buyservlet");
